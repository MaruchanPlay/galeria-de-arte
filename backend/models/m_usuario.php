...
class Usuario implements CRUD
{
    ...
    public function create()
    {
        ...
        $stmt = $conn->prepare("INSERT INTO usuario (nombre, apellidos, nacimiento, correo, telefono, genero, domicilio, foto) 
    ...
    public function update()
    {
        ...
        $stmt = $conn->prepare("UPDATE usuario SET nombre = :nombre, apellidos = :apellidos, nacimiento = :nacimiento, correo = :correo, telefono = :telefono, genero = :genero, domicilio = :domicilio,  foto = :foto  
                                WHERE id = :id");
        $stmt->bindParam(':nombre', $this->nombre);
        $stmt->bindParam(':apellidos', $this->apellidos);
        $stmt->bindParam(':nacimiento', $this->nacimiento);
