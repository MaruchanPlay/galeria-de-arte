<?php
include ('../../backend/models/m_usuario.php');
        ...
        case 1: //create
            if (isset($_REQUEST['nombre']) and isset($_REQUEST['apellidos']) and isset($_REQUEST['nacimiento']) and isset($_REQUEST['correo']) and isset($_REQUEST['telefono']) and isset($_REQUEST['genero']) and isset($_REQUEST['domicilio']) and isset($_FILES['foto'])) {
                ...
                if ($resultado == 1) {
                    ...
                    header('Location: ../../../../frontend/views/view_usuario/index.php?estatus=registrado');
                } else {
                    header('Location: ../../../../frontend/views/view_usuario/index.php?estatus=error');
                }
            } else {
                echo "Falta un dato";
            }
